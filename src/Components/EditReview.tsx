...
export default function EditReview(): JSX.Element {
    ...
    useEffect(() => {
        axios
            .get<{ restaurants: Restaurant[] }>("http://localhost:3000/api/listRestaurant")
    ...
    async function sendReview(e: React.FormEvent) {
        ...
        try {
            const resp = await axios.put("http://localhost:3000/api/review", data, {
                    ...
                    <div key={idx} className="space-y-4 border-t pt-4">
                        ...
                        <div className="flex flex-col">
                            ...
                            {typeof images[idx] === "string" && images[idx] && (
                                <img
                                    src={`http://localhost:3000/uploads/reviews/${images[idx]}`}
                                    alt="Podgląd"
